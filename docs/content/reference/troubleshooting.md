...
Most of these come down to network reality or how neurips serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

neurips rate-limits like any public site. neurips already paces
...
Where a surface is gated, neurips reads a cookie or token you supply
...
`neurips`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what neurips actually did
